    ...
    try {
      ...
      if (sub === 'add') {
        ...
        if (!provider || !keyValue) {
          return ctx.replyWithHTML([
            ...
            `• <code>/apikey add gemini AQ.xxxxx</code>`,
          ].join('\n'));
        }
      ...
      if (sub === 'remove' || sub === 'delete') {
        ...
        if (!provider || !selector) {
          return ctx.replyWithHTML(`❌ Format: <code>/apikey remove &lt;provider&gt; &lt;nomor atau key&gt;</code>`);
        }
      ...
      return ctx.replyWithHTML([
        ...
        `• <code>/apikey remove &lt;provider&gt; &lt;n atau key&gt;</code> — hapus key`,
